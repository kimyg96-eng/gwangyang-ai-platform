    ...
    <PageLayout>
      <section className="rounded-3xl bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 max-w-3xl leading-8 text-slate-600">
          광양 지역문화자산과 정채봉 문학 콘텐츠를 소재로 학습자가 직접
          이야기의 주제와 아이디어를 입력하고, AI와 함께 창작 이야기를 만드는
          공간입니다.
        </p>
      </section>
        ...
        <section className="rounded-3xl bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-6">
            ...
            <p className="mt-5 leading-8 text-slate-700">
              ...
              아프면 마을도 함께 아파진단다.” 민우는 친구들과 함께 강을
              깨끗하게 지키기 위한 작은 약속을 만들기 시작했습니다.
            </p>
            <p className="mt-4 leading-8 text-slate-700">
              그날 이후 민우와 친구들은 섬진강을 지키는 어린 수호대가
              되었습니다. 아이들은 쓰레기를 줍고, 강가의 생물을 관찰하며,
              자연과 사람이 함께 살아가는 방법을 배워 갔습니다.
            </p>
          </div>
